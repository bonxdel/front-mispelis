...
export const GlobalProvider = (props) => {
    ...
    // Si NO hay un usuario en el estado, no se realiza ninguna acción
        ...
        const respuesta = await fetch("https://api-mispelis.onrender.com/pelifavorita", {
            method: "POST",
    ...
    const nuevaVista = async (peli) => {
        ...
        try {
            ...
            const respuesta = await fetch("https://api-mispelis.onrender.com/pelivista", {
                method: "POST",
                headers: { "Content-Type": "application/json" },
                body: JSON.stringify({
                    ...peli,
    ...
    const borrarFav = async (id) => {
        try {
            ...
            const respuesta = await fetch(`https://api-mispelis.onrender.com/borrarpeli/${id}`, {
                method: "DELETE",
            })
    ...
    const vistaToFav = async (peli) => {
        ...
        if (estado.usuario) {
            try {
                ...
                const respuesta = await fetch(`https://api-mispelis.onrender.com/cambiarcategoria/${peli._id}`, {
                    method: "PUT",
                    headers: { "Content-Type": "application/json" },
                    body: JSON.stringify({
                        tipo: nuevoTipo,
    ...
    const cargarFavoritas = async (usuario) => {
        ...
        const respuesta = await fetch(`https://api-mispelis.onrender.com/mispelis/${usuario}/favorita`)
    ...
    const cargarVistas = async (usuario) => {
        ...
        try {
            ...
            const respuesta = await fetch(`https://api-mispelis.onrender.com/mispelis/${usuario}/vista`)
